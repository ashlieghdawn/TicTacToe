...
// this function styles the game buttons whil they are disabled
...
//when the user indicates, stp the current game and reset game
function stopGame(){
    hideGameMsg(); //clear the text and hide message box
    var btn=document.getElementById('btnStart');
    startEnabled(btn); //enable the starte button since the game is now stopped
    var btn=document.getElementById('btnStop');
...
// as square are selected they check in with this function to see if that particular
...
function checkWinCon1(info,squareArray){
    ...
    if (match0Avatar != undefined && match1Avatar != undefined && match2Avatar != undefined){
        if(match0Avatat==match1Avatar && match0Avatar==match2Avatar){
...
//------------------------------------------------------------------------------------------
// These block of cuntions are for each click event of their corresponding square element
//------------------------------------------------------------------------------------------
